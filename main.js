...
const scaleOptions = [
  { metric: true, imperial: true, position: 'bottomleft' },
  { metric: true, imperial: false, position: 'bottomleft' },
  { metric: false, imperial: true, position: 'bottomleft' }
];
...
function bindScaleClick() {
  ...
  // Custom HUD styling for the scale
  ...
  lines.forEach(line => {
    ...
    line.style.border = '1px solid var(--accent-color)';
